...
function mergeRealDataWithStats(currentStats, realData) {
    ...
    // Keep simulated data for exams and allergies until we have real APIs
    // mergedStats.exames = { ...mergedStats.exames };
    // mergedStats.alergias = { ...mergedStats.alergias };
        ...
        if (shouldRecalculate) {
            ...
            const dashboardStats = {
                ...
                examesRegistrados: {
                    ...
                    realData: false // Simulado até ter API real
                },
                medicosAtivos: {
